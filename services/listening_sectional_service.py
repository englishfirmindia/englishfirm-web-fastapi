...
LISTENING_STRUCTURE = [
    ...
    # Order aligned with APEUni Mock Test on 2026-05-21:
    # ASQ comes before SGD; MCQ-Single before SMW before HIW.
...
def get_listening_sectional_results(session_id: str, user_id: int, db: Session) -> dict:
    ...
    # Bulk-fetch question rows for rich review. Listening enrichment also
    # presigns the lecture audio URL on each question so the student can
    # replay the prompt during review.
