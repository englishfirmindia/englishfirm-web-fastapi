...
def list_questions(
    ...
    if practiced is not None:
        practiced_subq = practiced_questions_subq(db, current_user.id, "reading_fib_drop_down")
        if practiced:
    ...
    practiced_ids = practiced_question_ids_in(db, current_user.id, "reading_fib_drop_down", page_qids)
