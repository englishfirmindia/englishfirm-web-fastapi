...
def list_questions(
    ...
    if practiced is not None:
        practiced_subq = practiced_questions_subq(db, current_user.id, "describe_image")
        if practiced:
    ...
    practiced_ids = practiced_question_ids_in(db, current_user.id, "describe_image", page_qids)
