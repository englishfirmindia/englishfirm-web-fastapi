...
def list_questions(
    ...
    if practiced is not None:
        practiced_subq = practiced_questions_subq(db, current_user.id, "summarize_spoken_text")
        if practiced:
    ...
    practiced_ids = practiced_question_ids_in(db, current_user.id, "summarize_spoken_text", page_qids)
